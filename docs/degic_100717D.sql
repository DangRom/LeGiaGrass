...
BEGIN
    SELECT Id, Name, Activated, Service, Orders
    FROM Categorys
    ORDER BY Name, Id;
  END ;;
DELIMITER ;
...
BEGIN
    SELECT Name, Address, Phone, Hotline, Email,Sologan, BusinessHours, Facebook, Google, Twitter, TaxCode
    FROM Company
    LIMIT 1;
  END ;;
DELIMITER ;
...
BEGIN
    SELECT Sologan, BusinessHours,  Hotline, Facebook, Twitter, Google
    FROM Company
    LIMIT 1;
  END ;;
DELIMITER ;
