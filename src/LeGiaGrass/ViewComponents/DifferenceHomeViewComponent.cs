...
namespace LeGiaGrass.ViewComponents
{
    ...
    [ViewComponent(Name = "DifferenceHome")]
    public class DifferenceHomeViewComponent : ViewComponent
    {
        private readonly IServiceRepository _serviceRepo;

        public DifferenceHomeViewComponent(IServiceRepository serviceRepo) => _serviceRepo = serviceRepo;
