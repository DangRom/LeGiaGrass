...
{
    [ViewComponent(Name = "LatestNewHome")]
    public class LatestNewHomeViewComponent : ViewComponent
    {
        private readonly IServiceRepository _serviceRepo;

        public LatestNewHomeViewComponent(IServiceRepository serviceRepo) => _serviceRepo = serviceRepo;
