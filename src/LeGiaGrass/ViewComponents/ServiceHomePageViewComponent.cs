...
{
    [ViewComponent(Name = "ServiceHomePage")]
    public class ServiceHomePageViewComponent : ViewComponent
    {
        private readonly IServiceRepository _serviceRepo;

        public ServiceHomePageViewComponent(IServiceRepository serviceRepo) => _serviceRepo = serviceRepo;
