...
if( $_SERVER['REQUEST_METHOD'] == 'POST' ) {
    if( $_POST['reservation_name'] != '' AND $_POST['reservation_email'] != '' AND $_POST['service_name'] != '' AND $_POST['service_type'] != '') {
        ...
        if( $botcheck == '' ) {
            ...
            $service_name = isset($service_name) ? "Service Name: $service_name<br><br>" : '';
            $select_shift = isset($select_shift) ? "Select Shift: $select_shift<br><br>" : '';
            $service_type = isset($service_type) ? "Service Type: $service_type<br><br>" : '';
            $reservation_date = isset($reservation_date) ? "Reservation: $reservation_date<br><br>" : '';

            $referrer = $_SERVER['HTTP_REFERER'] ? '<br><br><br>This Form was submitted from: ' . $_SERVER['HTTP_REFERER'] : '';

            $body = "$name $email $phone $address $service_name $select_shift $service_type $reservation_date $referrer";
